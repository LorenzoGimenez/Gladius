...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES['pdf'])) {
    $nombre_archivo = 'parte_urgente.pdf';
    $archivo = file_get_contents($_FILES['pdf']['tmp_name']); // Leer el archivo como datos binarios
    $tamaño_archivo = $_FILES['pdf']['size'];
...
<div class="btn">
    ...
    <button id="sendToRepository" class="print-button">Enviar al Repositorio en PDF</button>
